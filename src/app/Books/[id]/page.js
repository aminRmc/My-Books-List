      ...
      <section className='w-full pt-10 flex justify-center'>
        {currentContent && (
          <div className='flex w-full max-w-4xl max-lg:flex-col min-h-sreen '>
            <div className='w-1/2 flex justify-center items-start pt-5 flex-col max-lg:w-full max-lg:flex-row max-lg:pl-4  m-0'>
              <img className='h-[500px] max-lg:h-[350px]' src={currentContent.image_url} alt={currentContent.title} />
              <div className='flex justify-center items-center w-full pt-5 gap-5 max-lg:flex-col max-lg:pt-44 '>
              ...
              {con==1&&
                ...
                <button className='btn bg-secondary rounded-xl ' disabled>Déjà dans les favoris</button> :
                <button className='btn bg-secondary rounded-xl ' onClick={() => dispatch(addfav(currentContent))}>Ajouter aux favoris</button>
              } 
              </div>
            </div>

            <div className='w-1/2 pt-0 ml-4 '>
